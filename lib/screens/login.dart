...
class _LoginPageState extends State<LoginPage> {
  ...
  String statusCode;
  Future<LoginDataModel> mAuthenticate(
    String contactNo,
    String devideId,
    String deviceName,
    String mac,
    ...
    try {
      ...
      debugPrint('Check mAuthenticate _API_Path $APIPath ');
      final String apiUrl = "$APIPath/Authentication/MobileAuthentication";
                      ...
                      child: InkWell(
                        onTap: () async {
                          if (_formStateKey.currentState.validate()) {
                            ...
                            if (connectivityResult == ConnectivityResult.none) {
                              print(
                                  "*** _isConnected Login btn = $connectivityResult ****");
                              Navigator.push(context,
                              ...
                              String APIPath =
                                  "https://mindtechsolutions.com/tester/EximApi/API";
                              // LIVE

                              // String APIPath =
                              //     "https://mindtechsolutions.com/tester/EximApiDev/API";
                              // //UAT
                              ...
                              final LoginDataModel result = await mAuthenticate(
                                  contactNo,
                                  devideId,
                                  deviceName,
                                  mac,
                              ...
                              if (statusCode == "200") {
                                String Status =
                                    "${_loginResult.Data[index].Status.toString()}";

                                if (Status == "1") {
                                  SharedPreferences prefs =
                                      await SharedPreferences.getInstance();
                                  prefs.setInt('EmpCode',
                                      _loginResult.Data[index].EmpCode);
                                  prefs.setInt('MCUserCode',
                                      _loginResult.Data[index].MCUserCode);
                                  prefs.setString('MobileNumber',
                                      _loginResult.Data[index].MobileNumber);
                                  prefs.setString('DeviceId', _devideId);

                                  debugPrint(
                                      'Check 2.1 EmpCode  : ${_loginResult.Data[index].EmpCode}');
                                  debugPrint(
                                      'Check 2.1 MCUserCode : ${_loginResult.Data[index].MCUserCode}');
                                  debugPrint(
                                      'Check 2.1 MobileNumber   : ${_loginResult.Data[index].MobileNumber}');
                                  debugPrint(
                                      'Check 2.1 DeviceId   : $_devideId');
