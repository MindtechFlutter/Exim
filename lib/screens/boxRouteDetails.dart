...
class BoxRouteDetailsPage extends StatefulWidget {
  ...
  @override
  _BoxRouteDetailsPageState createState() => _BoxRouteDetailsPageState();
}

class _BoxRouteDetailsPageState extends State<BoxRouteDetailsPage> {
  ...
  Future<void> _launchUrl() async {
    debugPrint('Your Url is - $loadUrl${widget.routeCode}/${widget.boxCode}');
    if (!await launchUrl(
        Uri.parse('$loadUrl${widget.routeCode}/${widget.boxCode}'))) {
      throw Exception(
