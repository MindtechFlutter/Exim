...
class _BoxDetailsPageState extends State<BoxDetailsPage> {
  ...
  Future<GetBoxDetailsDataModel> getBoxDetails() async {
    ...
    try {
      ...
      debugPrint('Check getBoxDetails _API_Path $APIPath ');
      debugPrint('Check getBoxDetails _Token $Token ');
      debugPrint(
          'Check getBoxDetails widget.exportType_value ${widget.exportType_value} ${widget.section}');
      String apiUrl = '';
      if (widget.section == null) {
        apiUrl = "$APIPath/Dashboard/GetBoxDetails";
        print("Api getBoxDetails _Token : GetBoxDetails");
        print(apiUrl);
      } else {
        apiUrl = "$APIPath/Dashboard/GetBoxDetailsNew";
        print("Api getBoxDetails _Token : GetBoxDetailsNew");
      }
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          _resultGetBoxDetailsResult = Json["Data"]
              .map<GetBoxDetailsResultModel>(
                  (e) => GetBoxDetailsResultModel.fromJson(e))
              .toList();
        });
                                ...
                                if (snapshot.hasData) {
                                  return ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      percentage = getBoxDetailsDataList[index]
                                              ["RoutePerc"] /
                                          100;
                                      return Padding(
                                        padding:
