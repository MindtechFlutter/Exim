...
//This function would be check if user is loggen in or not with the help of mc code which he will get from api.
  Future<int> _checkIfLoggedIn() async {
    final _prefs = await SharedPreferences.getInstance();
    int _isLoggedIn = _prefs.getInt('MC_EmpCode');

    print('(Future) Is Logged In value from shared prefernces is: ' +
  ...
  void check() async {
    ...
    if (connectivityResult == ConnectivityResult.wifi ||
      ...
      print(
          "*** _isConnected No Internet Connected page Load = $connectivityResult ****");
