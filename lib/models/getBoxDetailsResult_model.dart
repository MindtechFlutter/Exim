...
GetBoxDetailsResultModel getBoxDetailsResultModelFromJson(String str) =>
    GetBoxDetailsResultModel.fromJson(json.decode(str));

String getBoxDetailsResultModelToJson(GetBoxDetailsResultModel data) =>
...
class GetBoxDetailsResultModel {
  ...
  factory GetBoxDetailsResultModel.fromJson(Map<String, dynamic> json) =>
      GetBoxDetailsResultModel(
          ...
          PhyBoxLocation: json["PhyBoxLocation"]);
